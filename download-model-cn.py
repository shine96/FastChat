...
def get_download_links_from_minio(model, branch):
    ...
    while True:
        ...
        for i in range(len(dict)):
            ...
            if any((is_pytorch, is_safetensors, is_pt, is_tokenizer, is_text)):
                ...
                if is_text:
                    links.append(f"http://home.bnickolas.com:9000/model/{model}/{fname}")
...
if __name__ == '__main__':
    ...
    links, sha256, is_lora = get_download_links_from_minio(model, branch)
    ...
    if args.check:
        ...
        if not output_folder.exists():
            output_folder.mkdir()
        with open(output_folder / 'minio-metadata.txt', 'w') as f:
            f.write(f'url: http://home.bnickolas.com:9000/{model}\n')
